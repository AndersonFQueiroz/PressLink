    ...
    <main className="min-h-screen overflow-hidden bg-ink">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-8 sm:px-10 lg:px-16">
        <header className="flex items-center justify-between">
          <span className="font-display text-xl font-bold tracking-tight">press<span className="text-fuchsia-400">link</span></span>
          <a className="rounded-full border border-white/20 px-5 py-2 text-sm font-medium transition hover:border-white/50" href="#comece">
            Entrar
          </a>
        </header>
        ...
        <section className="relative flex flex-1 items-center py-20 lg:py-28">
          ...
          <div className="relative max-w-3xl">
            <p className="mb-6 text-sm font-semibold uppercase tracking-[0.28em] text-fuchsia-300">Seu som merece ser descoberto</p>
            <h1 className="font-display text-5xl font-bold leading-[0.98] tracking-tight sm:text-7xl lg:text-8xl">
              A pista é sua.<br /><span className="text-fuchsia-400">O palco também.</span>
            </h1>
            ...
            <div className="mt-10 flex flex-wrap gap-4" id="comece">
              <a className="rounded-full bg-fuchsia-500 px-7 py-3.5 font-semibold text-white shadow-lg shadow-fuchsia-500/20 transition hover:bg-fuchsia-400" href="#criar">
                Criar meu PressLink
              </a>
              <a className="rounded-full border border-white/20 px-7 py-3.5 font-semibold transition hover:border-white/50" href="#saiba-mais">
                Saiba mais
              </a>
            </div>
